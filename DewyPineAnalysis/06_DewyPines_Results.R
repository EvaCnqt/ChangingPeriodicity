...
sim.results = data.frame(treatment = c(rep(c(rep("Control", 500), rep("TSF>3", 500), rep("TSF3 and >3", 500), rep("TSF2, 3, and >3", 500), rep("TSF1, 2, 3, and >3", 500), rep("All TSFs", 500)), 8)), 
                         ...
                         ext.prob = c(stochasticFire15.control.sim[[3]], stochasticFire15.perturb.state5[[3]], stochasticFire15.perturb.state4_5[[3]], stochasticFire15.perturb.state3_4_5[[3]], stochasticFire15.perturb.state2_3_4_5[[3]], stochasticFire15.perturb.stateAll[[3]],
                                      ...
                                      periodicFire30.control.sim.avgdens
                                      [[3]], periodicFire30.perturb.state5.avgdens[[3]], periodicFire30.perturb.state4_5.avgdens[[3]], periodicFire30.perturb.state3_4_5.avgdens[[3]], periodicFire30.perturb.state2_3_4_5.avgdens[[3]], periodicFire30.perturb.stateAll.avgdens[[3]]))
...
cbind(aggregate(var.lambda ~ treatment + disturbance + density, data = sim.results, FUN = function(x) quantile(x, c(0.025, 0.5, 0.975))), mean = aggregate(var.lambda ~ treatment + disturbance + density, data = sim.results, FUN = "mean")$var.lambda)
...
tiff(filename = "DPAppendix7_AfterErrorCorrection.tiff",
    width=5,
    height=5,
    units="in",
    bg="white",

...
AICctab(survSD.LG1, survSD.LG2, survSD.LG3, base = T)
...
AICctab(survJ.LG1, survJ.LG2, survJ.LG3, base = T, nobs = nrow(data.grazing[data.grazing$stage == "J" & data.grazing$LS == "LG", ])) 
...
AICctab(survSR.LG1, survSR.LG2, survSR.LG3, base = T) 
...
AICctab(survLR.LG1, survLR.LG2, survLR.LG3, base = T) 
...
AICctab(survSD.HG1, survSD.HG2, survSD.HG3, base = T) 
...
AICctab(survJ.HG1, survJ.HG2, survJ.HG3, base = T) 
...
AICctab(survSR.HG1, survSR.HG2, survSR.HG3, base = T) 
...
AICctab(survLR.HG1, survLR.HG2, survLR.HG3, base = T) 
...
AICctab(transJ.LG1, transJ.LG2, transJ.LG3, base = T) 
...
AICctab(transJ.HG1, transJ.HG2, transJ.HG3, base = T)
...
AICctab(transSR.LG1, transSR.LG2, transSR.LG3, base = T) 
...
AICctab(transSR.HG1, transSR.HG2, transSR.HG3, base = T) 
...
AICctab(transLR.LG1, transLR.LG2, transLR.LG3, base = T) 
...
AICctab(transLR.HG1, transLR.HG2, transLR.HG3, base = T) 
...
AICctab(floweringprobSR.LG1, floweringprobSR.LG2, floweringprobSR.LG3, base = T) 
...
AICctab(floweringprobLR.LG1, floweringprobLR.LG2, floweringprobLR.LG3, base = T) 
...
AICctab(floweringprobSR.HG1, floweringprobSR.HG2, floweringprobSR.HG3, base = T) 
...
AICctab(floweringprobLR.HG1, floweringprobLR.HG2, floweringprobLR.HG3, base = T) 
...
AICctab(nbfsLR.LG1, nbfsLR.LG2, nbfsLR.LG3, base = T) 
...
AICctab(nbfpsLR.LG1, nbfpsLR.LG2, nbfpsLR.LG3, base = T) 
...
AICctab(nbfpsSR.HG1, nbfpsSR.HG2, nbfpsSR.HG3, base = T) 
...
AICctab(nbfpsLR.HG1, nbfpsLR.HG2, nbfpsLR.HG3, base = T) 

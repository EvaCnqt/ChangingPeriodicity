...
survJ.seasonOnly = survJ
survS.seasonOnly = survS
survH.seasonOnly = survH
survD.seasonOnly = survD
transition.seasonOnly = transition
emig.seasonOnly = emig
recruitment.H.seasonOnly = recruitment.H
recruitment.D.seasonOnly = recruitment.D

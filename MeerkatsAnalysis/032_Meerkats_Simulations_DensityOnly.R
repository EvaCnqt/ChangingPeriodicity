...
source("RScripts_ForSubmission_GithubMaterial/022_Meerkats_MPMs_DensityOnly.R")
...
stoch.sim.meerkat <- function(nsimul = 500,
  ...
  if(!is.null(vr.model)){
    ...
    if(formula(vr.model) == formula(recruitment.D.seasonOnly) | formula(vr.model) == formula(recruitment.H.seasonOnly)){
...
test2 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "high", vr.model = survH.seasonOnly)

test3 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "low", vr.model = survH.seasonOnly)

test4 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "high", vr.model = emig.seasonOnly)

test5 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "low", vr.model = emig.seasonOnly)

test6 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "high", vr.model = recruitment.H.seasonOnly)

test7 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "low", vr.model = recruitment.H.seasonOnly)

test8 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "high", vr.model = recruitment.D.seasonOnly)

test9 = stoch.sim.meerkat(nsimul = 10, nyears = 10, n0 = n0, dens0 = dens0, seasonality = "low", vr.model = recruitment.D.seasonOnly)
...
high.seas.S.surv.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = survS.seasonOnly)
...
high.seas.H.surv.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = survH.seasonOnly)
...
high.seas.D.surv.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = survD.seasonOnly)
...
high.seas.emig.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = emig.seasonOnly)
...
high.seas.trans.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = transition.seasonOnly)
...
high.seas.h.recruit.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = recruitment.H.seasonOnly)
...
high.seas.d.recruit.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "high", vr = recruitment.D.seasonOnly)
...
low.seas.S.surv.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = survS.seasonOnly)
...
low.seas.H.surv.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = survH.seasonOnly)
...
low.seas.D.surv.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = survD.seasonOnly)
...
low.seas.emig.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = emig.seasonOnly)
...
low.seas.trans.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = transition.seasonOnly)
...
low.seas.h.recruit.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = recruitment.H.seasonOnly)
...
low.seas.d.recruit.sim.dens.dep = stoch.sim.meerkat(nsimul = 500, nyears = 100, n0 = n0, dens0 = dens0, seasonality = "low", vr = recruitment.D.seasonOnly)
